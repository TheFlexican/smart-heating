...
class TestConfigHandlers:
    ...
    async def test_async_handle_set_opentherm_gateway_success(
        ...
        await async_handle_set_opentherm_gateway(
    ...
    async def test_async_handle_set_opentherm_gateway_error(
        ...
        mock_area_manager.set_opentherm_gateway.side_effect = ValueError(
            "Invalid gateway"
        )
    ...
    async def test_async_handle_set_trv_temperatures_success(
        ...
        await async_handle_set_trv_temperatures(
            call, mock_area_manager, mock_coordinator
        )
    ...
    async def test_async_handle_set_trv_temperatures_error(
        ...
        mock_area_manager.set_trv_temperatures.side_effect = ValueError(
    ...
    async def test_async_handle_set_frost_protection_success(
        ...
        await async_handle_set_frost_protection(
            call, mock_area_manager, mock_coordinator
        )
    ...
    async def test_async_handle_set_history_retention_error(
        ...
        mock_history_tracker.set_retention_days.side_effect = Exception(
            "Invalid retention"
        )
