...
class TestIntegrationSetup:
    ...
    async def test_async_setup_entry_with_opentherm_config(self, hass: HomeAssistant):
...
class TestIntegrationData:
    ...
    async def test_coordinator_stored_correctly(self, hass: HomeAssistant, mock_config_entry):
        ...
        with (
            patch("smart_heating.AreaManager") as mock_area_class,
            patch("smart_heating.HistoryTracker") as mock_history_class,
            patch("smart_heating.AreaLogger"),
            patch("smart_heating.VacationManager") as mock_vacation_class,
            patch("smart_heating.SafetyMonitor") as mock_safety_class,
    ...
    async def test_all_managers_stored(self, hass: HomeAssistant, mock_config_entry):
