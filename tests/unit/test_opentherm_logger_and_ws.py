...
def test_websocket_get_areas_success():
    ...
    area.boost_manager.night_boost_offset = 0
    area.boost_manager.night_boost_start_time = None
    area.boost_manager.night_boost_end_time = None
    ...
    area.boost_manager.boost_temp = None
    area.boost_manager.boost_duration = None
    area.hvac_mode = None
    area.window_sensors = []
