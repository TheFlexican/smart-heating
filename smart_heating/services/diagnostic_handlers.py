...
async def _force_single_thermostat(
    hass: HomeAssistant,
    thermostat_id: str,
    area_id: str,
    ...
    """Force updates for a single thermostat.
    ...
    Args:
        ...
        target_temp: Target temperature to set (optional)
        hvac_mode: HVAC mode to set (optional)

    Raises:
        Exception: Any error during thermostat forcing
    """
    _LOGGER.info("Diagnostic: Forcing updates for thermostat %s (area=%s)", thermostat_id, area_id)
