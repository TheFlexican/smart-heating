...
- Opgelost: **Geschiedenisgrafiek** — geef automatisch de voorkeur aan database-geschiedenis wanneer de database inzendingen bevat (voorkomt dat geschiedenis verloren gaat na een herstart). Normaliseer 'state' waarden geladen uit de database zodat verwarmings-/koelingsindicatoren correct in de frontend worden weergegeven. (#issue)
